...
/*                                                                     */
/* iOS のナビゲーションバーは端から 16pt の余白を空け、ボタンの当たり    */
/* 判定は 44pt 角。実機のスクリーンショットを実測しても、円の中心は      */
/* 右端から 38.2pt（= 16 + 44/2）で一致した。                           */
/* ------------------------------------------------------------------ */
...
export default function Index() {
  ...
  // カテゴリー分けして表示する品詞。動詞は活用型で分けず、id 順の一覧にする。
  const browse = q.trim() === '' && pos !== '全て' && pos !== '動詞';
